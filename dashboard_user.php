...
<head>
    ...
    <style>
        ...
        .session-card { border-radius: 15px; }
        .btn-hadir { padding: 15px 40px; font-size: 1.2rem; border-radius: 50px; }
        .session-active { border-left: 5px solid #28a745; }
        .session-waiting { border-left: 5px solid #ffc107; }
        .session-closed { border-left: 5px solid #6c757d; }
...
<div class="container mt-4 mb-5">
    ...
    <div class="alert alert-<?= $msg_type ?> alert-dismissible fade show" role="alert">
        <i class="fa fa-<?= $msg_type == 'success' ? 'check-circle' : ($msg_type == 'warning' ? 'exclamation-circle' : 'times-circle') ?> me-2"></i>
        <?= $msg ?>
    ...
    <div class="card session-card shadow-sm mb-4 <?= $active_session ? 'session-active' : ($next_session ? 'session-waiting' : 'session-closed') ?>">
        <div class="card-body text-center py-4">
            <?php if($active_session): ?>
                ...
                <p class="text-muted mb-4">
                    ...
                    <?= date('H:i', strtotime($active_session['jam_mulai'])) ?> - <?= date('H:i', strtotime($active_session['jam_selesai'])) ?> WIB
                </p>
            ...
            <div class="table-responsive">
                <table class="table table-striped mb-0">
                    <thead class="table-light">
                        <tr><th class="ps-3">No</th><th>Waktu</th><th>Sesi</th></tr>
                    </thead>
                    <tbody>
                        <?php
                        $no = 1;
