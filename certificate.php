...
<head>
    ...
    <style>
        ...
        #cert-container {
            ...
            /* Scale dari atas tengah */
        }

        #cert-image {
            display: block;
            pointer-events: none;
            /* Biar gak ke-drag gambarnya */
        }
        ...
        #draggable-name {
            ...
            font-family:
                <?= !empty($font_path) ? "'CustomFont', sans-serif" : "sans-serif" ?>
            ;
            font-size:
                <?= $font_size ?>
                px;
        ...
        <div class="card shadow border-0 mb-4 mx-auto" style="max-width: 100%;">
            <div class="card-body">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" id="input-name" class="form-control text-center mb-2" value="<?= $user_name ?>">
